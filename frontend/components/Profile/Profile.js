...
const ProfileScreen = () => {
  ...
  const getUserBio = async () => {
    try {
      const response = await axios.get(`http://192.168.18.70:8000/users/bio/4`);
  ...
  const getUserContactInfo = async () => {
    try {
      const response = await axios.get(
        `http://192.168.18.70:8000/users/contactinfo/5`
      );
  ...
  const getAllSkills = async () => {
    try {
      const {
        data: { skills },
      } = await axios.get("http://192.168.18.70:8000/user_skills/"+user?.userid);
      console.log(skills);
  ...
  const getAllLanguages = async () => {
    try {
      const {
        data: { languages },
      } = await axios.get("http://192.168.18.70:8000/user_languages/"+user?.userid);
  ...
  const getAllEducations = async () => {
    try {
      const {
        data: { educations },
      } = await axios.get("http://192.168.18.70:8000/education/"+user?.userid);
  ...
  const getAllWorkExperience = async () => {
    try {
      const {
        data: { workExperience },
      } = await axios.get("http://192.168.18.70:8000/user_work_experience/4");
  ...
  const handleSaveContactInfo = async () => {
    try {
      const response = await axios.put(`192.168.18.70:8000/users/5`, {
        email,
        phone,
        linkedinurl,
      });
  ...
  const handleSaveBio = async () => {
    try {
      const response = await axios.put(`http://192.168.18.70:8000/users/4`, {
        bio,
      });
      console.log(response.data); // Log the response from the server
  ...
  const handleAddEducation = async () => {
    ...
    try {
      await axios.post("http://192.168.18.70:8000/education/9", {
  ...
  const handleAddWorkExperience = async () => {
    ...
    try {
      await axios.post("http://192.168.18.70:8000/user_work_experience/4", {
        job_title: jobTitle,
        companyname: companyName,
        location,
        start_date: startDate,
  ...
  const handleDeleteEducation = async (educationID) => {
    try {
      await axios.delete(`http://192.168.18.70:8000/education/${educationID}`);
  ...
  const handleDeleteWorkExperience = async (workExperienceID) => {
    try {
      await axios.delete(
        `http://192.168.18.70:8000/user_work_experience/${workExperienceID}`
      );
  ...
  const handleAddHardSkill = async () => {
    ...
    try {
      await axios.post("http://192.168.18.70:8000/user_skills/"+user?.userid, {
  ...
  const handleDeleteSkill = async (skillID) => {
    try {
      await axios.delete(`http://192.168.18.70:8000/user_skills/${skillID}`);
      await getAllSkills();
    } catch (error) {}
  };
  ...
  const handleAddLanguage = async () => {
    ...
    try {
      await axios.post("http://192.168.18.70:8000/user_languages/9", {
  ...
  const handleDeleteLanguage = async (languageID) => {
    try {
      await axios.delete(
        `http://192.168.18.70:8000/user_languages/${languageID}`
      );
